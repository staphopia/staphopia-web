    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment_accession', models.ForeignKey(db_column='experiment_accession', on_delete=django.db.models.deletion.CASCADE, to='ena.Experiment')),
            ],
        ),
        migrations.CreateModel(
            name='SraLink',
            fields=[
                ...
                ('last_checked', models.DateTimeField(auto_now=True)),
                ('is_queried', models.BooleanField(default=False)),
                ('experiment_accession', models.OneToOneField(db_column='experiment_accession', on_delete=django.db.models.deletion.CASCADE, to='ena.Experiment')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment_accession', models.ForeignKey(db_column='experiment_accession', on_delete=django.db.models.deletion.CASCADE, to='ena.Experiment')),
                ('publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publication', to='publication.Publication')),
            ],
        ),
        migrations.AddField(
            model_name='experiment',
            name='study_accession',
            field=models.ForeignKey(db_column='study_accession', on_delete=django.db.models.deletion.CASCADE, to='ena.Study'),
        ),
    ]
