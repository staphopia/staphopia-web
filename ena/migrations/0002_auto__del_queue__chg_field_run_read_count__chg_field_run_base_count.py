...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Run.read_count'
        db.alter_column(u'ena_run', 'read_count', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Run.base_count'
        db.alter_column(u'ena_run', 'base_count', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Run.read_count'
        db.alter_column(u'ena_run', 'read_count', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Run.base_count'
        db.alter_column(u'ena_run', 'base_count', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'ena.run': {
            ...
            'base_count': ('django.db.models.fields.BigIntegerField', [], {}),
            ...
            'read_count': ('django.db.models.fields.BigIntegerField', [], {}),
